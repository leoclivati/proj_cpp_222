...
tensorflow_lite/tensorflow/lite/micro/tools/make/downloads/pigweed/pw_trace/example/%.o tensorflow_lite/tensorflow/lite/micro/tools/make/downloads/pigweed/pw_trace/example/%.su: ../tensorflow_lite/tensorflow/lite/micro/tools/make/downloads/pigweed/pw_trace/example/%.cc tensorflow_lite/tensorflow/lite/micro/tools/make/downloads/pigweed/pw_trace/example/subdir.mk
...
clean-tensorflow_lite-2f-tensorflow-2f-lite-2f-micro-2f-tools-2f-make-2f-downloads-2f-pigweed-2f-pw_trace-2f-example:
	-$(RM) ./tensorflow_lite/tensorflow/lite/micro/tools/make/downloads/pigweed/pw_trace/example/basic.d ./tensorflow_lite/tensorflow/lite/micro/tools/make/downloads/pigweed/pw_trace/example/basic.o ./tensorflow_lite/tensorflow/lite/micro/tools/make/downloads/pigweed/pw_trace/example/basic.su ./tensorflow_lite/tensorflow/lite/micro/tools/make/downloads/pigweed/pw_trace/example/sample_app.d ./tensorflow_lite/tensorflow/lite/micro/tools/make/downloads/pigweed/pw_trace/example/sample_app.o ./tensorflow_lite/tensorflow/lite/micro/tools/make/downloads/pigweed/pw_trace/example/sample_app.su
