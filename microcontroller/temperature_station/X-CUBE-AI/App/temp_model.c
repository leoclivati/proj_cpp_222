...
#define AI_NET_OBJ_INSTANCE g_temp_model
 
#undef AI_TEMP_MODEL_MODEL_SIGNATURE
#define AI_TEMP_MODEL_MODEL_SIGNATURE     "66db09f301c8e46fcb6a1627f22c370a"
...
#define AI_TOOLS_DATE_TIME   "Mon Dec 12 12:30:59 2022"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_TEMP_MODEL_N_BATCHES
#define AI_TEMP_MODEL_N_BATCHES         (1)
...
AI_STATIC ai_array dense_0_bias_array;   /* Array #2 */
AI_STATIC ai_array dense_0_weights_array;   /* Array #3 */
AI_STATIC ai_array serving_default_dense_input0_output_array;   /* Array #4 */
AI_STATIC ai_array dense_0_output_array;   /* Array #5 */
AI_STATIC ai_array nl_0_output_array;   /* Array #6 */
...
AI_STATIC ai_tensor dense_0_bias;   /* Tensor #2 */
AI_STATIC ai_tensor dense_0_weights;   /* Tensor #3 */
AI_STATIC ai_tensor serving_default_dense_input0_output;   /* Tensor #4 */
AI_STATIC ai_tensor dense_0_output;   /* Tensor #5 */
AI_STATIC ai_tensor nl_0_output;   /* Tensor #6 */
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 9, 16, 1, 1), AI_STRIDE_INIT(4, 4, 36, 576, 576),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 64, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_TEMP_MODEL_IN_NUM, &serving_default_dense_input0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_TEMP_MODEL_OUT_NUM, &dense_1_output),
...
AI_API_ENTRY
ai_bool ai_temp_model_get_info(
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_TEMP_MODEL_MODEL_NAME,
      .model_signature   = AI_TEMP_MODEL_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_handle ai_temp_model_destroy(ai_handle network)
{
...
AI_API_ENTRY
ai_i32 ai_temp_model_forward(ai_handle network, const ai_buffer* input)
{
